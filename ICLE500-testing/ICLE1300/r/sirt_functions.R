### The following code was written by Ian Jones (https://www.lboro.ac.uk/departments/maths-education/staff/ian-jones/). It is publicly available via NoMoreMarking.com, who host it on their Github page: https://github.com/NoMoreMarking/sirt.
