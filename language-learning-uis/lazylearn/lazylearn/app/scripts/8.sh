...
EXERCISES_DIR="./assets/exercises"
MAIN_GO_FILE="./cmd/lazylearn/main.go"

# Ensure the directories exist
mkdir -p "$EXERCISES_DIR"

# Create markdown files for exercises
echo "Creating markdown files for exercises..."

cat <<EOL > "$EXERCISES_DIR/exercise_1.md"
...
cat <<EOL > "$EXERCISES_DIR/exercise_2.md"
...
cat <<EOL > "$EXERCISES_DIR/exercise_3.md"
...
# Update main.go to load exercises from markdown files
echo "Updating main.go to load exercises from markdown files..."
...
echo "The main.go file has been updated with markdown file support and exercise content loading!"
